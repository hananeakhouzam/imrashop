                        ...
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">الموضفة </h6>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-xl-12">
                                    <div class="form-layout form-layout-12">
                                       ...
                                       <div class="row">
                                          <label class="col-sm-12 form-control-label">اسم الموظفة: <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                     <input type="text" class="form-control" placeholder="اسم الموظفة">
                                          </div>
                                       </div>
                                       <!-- row -->
                                       <div class="row">
                                          <label class="col-sm-12 form-control-label">البريد الإلكتروني: <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                             <input type="text" class="form-control" placeholder=" البريد الإلكتروني">
                                          </div>
                                       </div> <div class="row">
                                          <label class="col-sm-12 form-control-label">كلمة المرور
                                               : <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                             <input type="text" class="form-control" placeholder=" كلمة المرور">
                                          </div>
                                       </div> <div class="row">
                                          <label class="col-sm-12 form-control-label">رقم الهاتف
                            : <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
...
">
                                       ...
                                       <div class="form-layout-footer mg-t-30">
                                          <button class="btn btn-primary"> انشاء المستخدم </button>
                                       </div>
                                       <!-- form-layout-footer -->
                                    </div>
                                    <!-- form-layout -->
 ...
 <div class="col-md-12 col-lg-12">
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">مرسل الطلبات  </h6>
                                 </div>
                              ...
                              <div class="row">
                                 <div class="col-xl-12">
                                    <div class="form-layout form-layout-12">
                                       ...
                                       <div class="row">
                                          <label class="col-sm-12 form-control-label">اسم المستخدم
: <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
...
">
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="row">
                                          <label class="col-sm-12 form-control-label">عمولة المرسلة
                                               : <span class="tx-danger">*</span></label>
                                          <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                             <input type="text" class="form-control" placeholder=" عمولة المرسلة">
                                          </div>
                                       </div> 
 ...
 <div class="col-md-12 col-lg-12">
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">مدير   </h6>
                                 </div>
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">مضيفة بيانات    </h6>
                                 </div>
...
">
                                       ...
                                       <div class="form-layout-footer mg-t-30" >
  <button class="btn btn-primary" data-feather="arrow-left-circle"> انشاء المستخدم    </button>
                                       </div>
                                       <!-- form-layout-footer -->
                                    </div>
                                    <!-- form-layout -->
                     ...
                     <div class="col-md-12 col-lg-12">
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0"> لجنة المتابعة    </h6>
                                 </div>
